...
def set_output_layer_metadata(
    ...
    *,
    ...
    output_is_full_resolution_key: str = '',
    ...
    if output_is_full_resolution_key:
        layer.metadata[output_is_full_resolution_key] = is_full_resolution
...
class ViewerLayerService:
    ...
    def set_or_add_input_preview_layer(
        ...
        *,
        ...
        # 强制 0-1 渲染范围。prepare_input_color_preview_image 永远输出 float32 ∈ [0, 1]，
        # 但 napari 的 contrast_limits 不会随 dtype 切换自动重置，这里兜底防止纯黑显示。
        try:
            preview_layer.contrast_limits = (0.0, 1.0)
        except Exception:
            pass
    ...
    def set_or_add_output_layer(
        ...
        *,
        ...
        set_output_layer_metadata(
            ...
            output_is_full_resolution_key=self.output_is_full_resolution_key,
